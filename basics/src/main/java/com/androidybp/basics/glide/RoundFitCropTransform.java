 ...
 * Glide圆角CenterCrop转换
 */
public class RoundFitCropTransform extends FitCenter {
    ...
    public RoundFitCropTransform(int radius) {
        this(radius, 0, CornerType.ALL);
    }

    public RoundFitCropTransform(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public RoundFitCropTransform(int radius, CornerType cornerType) {
        this(radius, 0, cornerType);
    }


    public RoundFitCropTransform(int radius, int margin, CornerType cornerType) {
        mRadius = radius;
        mDiameter = mRadius * 2;
        mMargin = margin;
