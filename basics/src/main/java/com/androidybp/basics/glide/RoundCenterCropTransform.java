 ...
 *
 * @author yangchong
 * created on 2019/1/6 12:03
 */
public class RoundCenterCropTransform extends CenterCrop {
    ...
    public RoundCenterCropTransform(int radius) {
        this(radius, 0, CornerType.ALL);
    }

    public RoundCenterCropTransform(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public RoundCenterCropTransform(int radius, CornerType cornerType) {
        this(radius, 0, cornerType);
    }


    public RoundCenterCropTransform(int radius, int margin, CornerType cornerType) {
        mRadius = radius;
        mDiameter = mRadius * 2;
        mMargin = margin;
