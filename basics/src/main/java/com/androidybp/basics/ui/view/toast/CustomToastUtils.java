...
import com.androidybp.basics.ui.view.toast.style.ToastBlackStyle;
import com.androidybp.basics.ui.view.toast.style.ToastQQStyle;
import com.androidybp.basics.ui.view.toast.style.ToastWhiteStyle;
...
public final class CustomToastUtils {
    ...
    /**
     * 初始化 CustomToastUtils，在Application中初始化
     *
    ...
    /**
     * 检查吐司状态，如果未初始化请先调用{@link CustomToastUtils#init(Application)}
     */
