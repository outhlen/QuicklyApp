...
public class ElectricFanLoadingRenderer extends LoadingRenderer {
    ...
    private static String PERCENTAGE_100 = "0%";
    ...
    private void init(Context context) {
        ...
        mWidth = ResourcesTransformUtil.dip2px(context, DEFAULT_WIDTH);
        mHeight = ResourcesTransformUtil.dip2px(context, DEFAULT_HEIGHT);
        mTextSize = ResourcesTransformUtil.dip2px(context, DEFAULT_TEXT_SIZE);
        mStrokeWidth = ResourcesTransformUtil.dip2px(context, DEFAULT_STROKE_WIDTH);
        mCenterRadius = ResourcesTransformUtil.dip2px(context, DEFAULT_CENTER_RADIUS);
        mProgressCenterRadius = ResourcesTransformUtil.dip2px(context, DEFAULT_PROGRESS_CENTER_RADIUS);
    ...
    protected void draw(Canvas canvas, Rect bounds) {
        ...
        mPaint.setTextSize(mTextSize * 0.9f);
        mPaint.setColor(mElectricFanOutlineColor);
    ...
    public void setNumber(float number) {
        PERCENTAGE_100 = (int) (number * 100) + "%";
        computeRender(number);
        invalidateSelf();
        if (mScale == 0) {
            reset();
        }
