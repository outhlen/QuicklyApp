...
public class LoadingUnloadItemEntity {


    public long id;//    主键id
    public String orderNumber;//    订单号
    public int installType;//    装货状态(0未完成1已完成)
    public int unloadType;//    卸货状态(0未完成1已完成)
    public String startCityCode;//    始发市
    public String startAddr;//    始发地详细地址
    public String endCityCode;//    目的地市
    public String endAddr;//    目的地详细地址
    public String startCellphone;//    发货手机号码
    public String endCellphone;//    收货手机号码
