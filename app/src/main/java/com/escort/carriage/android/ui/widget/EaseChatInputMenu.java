...
public class EaseChatInputMenu extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        layoutInflater.inflate(com.hyphenate.helpdesk.R.layout.hd_widget_chat_input_menu, this);
        primaryMenuContainer = (FrameLayout) findViewById(com.hyphenate.helpdesk.R.id.primary_menu_container);
        emojiconMenuContainer = (FrameLayout) findViewById(com.hyphenate.helpdesk.R.id.emojicon_menu_container);
        chatExtendMenuContainer = (FrameLayout) findViewById(com.hyphenate.helpdesk.R.id.extend_menu_container);
        // 扩展按钮栏
        chatExtendMenu = (ExtendMenu) findViewById(com.hyphenate.helpdesk.R.id.extend_menu);
        emojiSendBtn = (Button) findViewById(com.hyphenate.helpdesk.R.id.emoji_send_button);
    ...
    public void init(List<EmojiconGroupEntity> emojiconGroupList) {
        ...
        if (chatPrimaryMenu == null) {
            chatPrimaryMenu = (EaseChatPrimaryMenuBase) layoutInflater.inflate(com.hyphenate.helpdesk.R.layout.hd_layout_chat_primary_menu,
                    null);
        }
        ...
        if (emojiconMenu == null) {
            emojiconMenu = (EmojiconMenu) layoutInflater.inflate(com.hyphenate.helpdesk.R.layout.hd_layout_emojicon_menu, null);
            if (emojiconGroupList == null) {
                emojiconGroupList = new ArrayList<EmojiconGroupEntity>();
                EmojiconGroupEntity emojiconGroupEntity = new EmojiconGroupEntity(com.hyphenate.helpdesk.R.drawable.e_e_1, Arrays
                        .asList(DefaultEmojiconDatas.getData()));
                emojiconGroupEntity.setName(context.getString(com.hyphenate.helpdesk.R.string.emojicon_text_default));
