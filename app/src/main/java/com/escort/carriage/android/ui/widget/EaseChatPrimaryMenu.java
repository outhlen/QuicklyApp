...
public class EaseChatPrimaryMenu extends EaseChatPrimaryMenuBase implements View.OnClickListener {
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(com.hyphenate.helpdesk.R.layout.hd_widget_chat_primary_menu, this, true);
        buttonSetModeVoice = findViewById(com.hyphenate.helpdesk.R.id.btn_set_mode_voice);
        buttonSetModeKeyboard = findViewById(com.hyphenate.helpdesk.R.id.btn_set_mode_keyboard);
        edittext_layout = (RelativeLayout) findViewById(com.hyphenate.helpdesk.R.id.edittext_layout);
        editText = (EditText) findViewById(com.hyphenate.helpdesk.R.id.et_sendmessage);
        buttonPressToSpeak = (RecorderMenu) findViewById(com.hyphenate.helpdesk.R.id.record_menu);
        faceLayout = (RelativeLayout) findViewById(com.hyphenate.helpdesk.R.id.rl_face);
        faceNormal = (ImageView) findViewById(com.hyphenate.helpdesk.R.id.iv_face);
        faceKeyboard = (ImageView) findViewById(com.hyphenate.helpdesk.R.id.iv_face_keyboard);
        buttonMore = (Button) findViewById(com.hyphenate.helpdesk.R.id.btn_more);
        buttonLess = (Button) findViewById(com.hyphenate.helpdesk.R.id.btn_less);
        buttonSend = (Button) findViewById(com.hyphenate.helpdesk.R.id.btn_send);
        edittext_layout.setBackgroundResource(com.hyphenate.helpdesk.R.drawable.hd_input_bar_bg_normal);
        ...
        editText.setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    edittext_layout.setBackgroundResource(com.hyphenate.helpdesk.R.drawable.hd_input_bar_bg_active);
                    if(listener != null){
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == com.hyphenate.helpdesk.R.id.btn_set_mode_voice) {
            if (listener != null)
                listener.onToggleVoiceBtnClicked();
            setModeVoice();
        } else if (id == com.hyphenate.helpdesk.R.id.btn_set_mode_keyboard) {
            if (listener != null)
                listener.onToggleVoiceBtnClicked();
            editText.requestFocus();
            displayKeyboard(editText);
        } else if (id == com.hyphenate.helpdesk.R.id.btn_more) {
            hideVoiceMode();
            showMoreorLess(false);
            showNormalFaceImage();
            if (listener != null)
                listener.onToggleExtendClicked();
        } else if (id == com.hyphenate.helpdesk.R.id.btn_less) {
            showMoreorLess(true);
            if (listener != null)
                listener.onToggleExtendClicked();
        } else if (id == com.hyphenate.helpdesk.R.id.et_sendmessage) {
            edittext_layout.setBackgroundResource(com.hyphenate.helpdesk.R.drawable.hd_input_bar_bg_active);
            ...
            if (listener != null)
                listener.onEditTextClicked();
        } else if (id == com.hyphenate.helpdesk.R.id.iv_face) {
            refleshEmojiSendBtn();
            toggleFaceImage();
            showMoreorLess(true);
            hideVoiceMode();
        ...
        } else if (id == com.hyphenate.helpdesk.R.id.iv_face_keyboard) {
            toggleFaceImage();
            if (listener != null) {
                listener.onToggleEmojiconClicked();
            }
    ...
    private void refleshEmojiSendBtn() {
        if (editText.getText().length() > 0 && !emojiSengBtnEnable) {
            if (emojiSendBtn != null) {
                ...
                emojiSendBtn.setBackgroundResource(com.hyphenate.helpdesk.R.color.emoji_send_btn_enable_bg_color);
            }
            emojiSengBtnEnable = true;
        } else if(editText.getText().length() == 0 && emojiSengBtnEnable) {
            if (emojiSendBtn != null) {
                emojiSendBtn.setEnabled(false);
                emojiSendBtn.setBackgroundResource(com.hyphenate.helpdesk.R.color.emoji_send_btn_disable_bg_color);
            }
            emojiSengBtnEnable = false;
        }
