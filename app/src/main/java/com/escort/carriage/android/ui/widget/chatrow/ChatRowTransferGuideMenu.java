...
public class ChatRowTransferGuideMenu extends ChatRow {
    ...
    protected void onInflatView() {
        inflater.inflate(message.direct() == Message.Direct.RECEIVE ? com.hyphenate.helpdesk.R.layout.hd_row_received_menu
                : com.hyphenate.helpdesk.R.layout.hd_row_sent_message, this);
    }

    @Override
    protected void onFindViewById() {
        tvTitle = (TextView) findViewById(com.hyphenate.helpdesk.R.id.tvTitle);
        tvList = (LinearLayout) findViewById(com.hyphenate.helpdesk.R.id.ll_layout);
    }
    ...
    private void setTransferGuideMenuMessageLayout(LinearLayout parentView, final TransferGuideMenuInfo menuInfo){
        ...
        if (menuInfo.getItems() != null && !menuInfo.getItems().isEmpty()){
            ...
            for(final TransferGuideMenuInfo.Item item : items) {
                ...
                textView.setTextColor(context.getResources().getColorStateList(com.hyphenate.helpdesk.R.color.hd_menu_msg_text_color));
