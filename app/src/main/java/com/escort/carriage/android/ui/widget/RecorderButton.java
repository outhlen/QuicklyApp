        ...
        if (mCurState != state) {
            ...
            switch (state) {
                case STATE_NORMAL:
                    ...
                    setText(com.hyphenate.helpdesk.R.string.button_pushtotalk);
                    break;
                case STATE_RECORDING:
                    ...
                    setText(com.hyphenate.helpdesk.R.string.str_recorder_recording);
                    mDialogManager.recording();
                    break;
                case STATE_WANT_TO_CANCEL:
                    setBackgroundResource(com.hyphenate.helpdesk.R.drawable.hd_btn_recorder_recording);
                    setText(com.hyphenate.helpdesk.R.string.release_to_cancel);
