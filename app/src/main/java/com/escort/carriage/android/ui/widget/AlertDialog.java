...
public class AlertDialog extends Dialog {
    ...
    public AlertDialog(Context context, int msgId) {
        super(context);
        this.title = context.getResources().getString(com.hyphenate.helpdesk.R.string.prompt);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.hyphenate.helpdesk.R.layout.hd_alert_dialog);

        Button cancel = (Button)findViewById(com.hyphenate.helpdesk.R.id.btn_cancel);
        Button ok = (Button)findViewById(com.hyphenate.helpdesk.R.id.btn_ok);
        TextView titleView = (TextView) findViewById(com.hyphenate.helpdesk.R.id.title);
        setTitle(title);

        View.OnClickListener listener = new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (view.getId() == com.hyphenate.helpdesk.R.id.btn_ok) {
                    onOk(view);
                } else if (view.getId() == com.hyphenate.helpdesk.R.id.btn_cancel) {
                    onCancel(view);
                }
            }
        };
        ...
        if (msg != null)
            ((TextView)findViewById(com.hyphenate.helpdesk.R.id.alert_message)).setText(msg);
    }
