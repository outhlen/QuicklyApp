...
public class ExtendMenu extends GridView {
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, com.hyphenate.helpdesk.R.styleable.EaseChatExtendMenu);
        int numColumns = ta.getInt(com.hyphenate.helpdesk.R.styleable.EaseChatExtendMenu_numColumns, 4);
        ta.recycle();
    ...
    class ChatMenuItem extends LinearLayout {
        ...
        private void init(Context context, AttributeSet attrs) {
            LayoutInflater.from(context).inflate(com.hyphenate.helpdesk.R.layout.hd_chat_menu_item, this);
            imageView = (ImageView) findViewById(com.hyphenate.helpdesk.R.id.image);
            textView = (TextView) findViewById(com.hyphenate.helpdesk.R.id.text);
        }
