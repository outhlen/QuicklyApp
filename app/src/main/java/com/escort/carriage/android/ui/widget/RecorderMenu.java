...
public class RecorderMenu extends RelativeLayout implements AudioManager.AudioStateListener{
	...
	private void init(Context context) {
		LayoutInflater.from(context).inflate(com.hyphenate.helpdesk.R.layout.hd_widget_recorder_menu, this, true);
		mRecordText = (TextView) findViewById(com.hyphenate.helpdesk.R.id.record_menu_text);
		mRecordBtn = (ImageButton) findViewById(com.hyphenate.helpdesk.R.id.record_menu_image_btn);
				...
				switch (action) {
					...
					case MotionEvent.ACTION_UP:
						if (!mReady) {
							...
							/*Dialog显示时间短*/
							mDialogManager.dismissDialog();
							mRecordText.setText(com.hyphenate.helpdesk.R.string.ease_record_menu_too_short);
							mRecordBtn.setBackgroundResource(com.hyphenate.helpdesk.R.drawable.hd_record_menu_too_short);
	...
	private void changeState(int state) {
		...
		if (mCurState != state) {
			...
			switch (state) {
				case STATE_NORMAL:
					setBackgroundResource(com.hyphenate.helpdesk.R.drawable.hd_btn_recorder_normal);
					mRecordText.setText(com.hyphenate.helpdesk.R.string.button_pushtotalk);
					mRecordBtn.setBackgroundResource(com.hyphenate.helpdesk.R.drawable.hd_record_menu_mic_gray);
					break;
				case STATE_RECORDING:
					if (!isHasRecorderPermission) {
						...
						if (!hasPermission) {
							reset();
							ToastHelper.show(getContext(), com.hyphenate.helpdesk.R.string.Recording_without_permission);
							return;
						}
					}
					isHasRecorderPermission = true;
					setBackgroundResource(com.hyphenate.helpdesk.R.drawable.hd_btn_recorder_recording);
					mRecordText.setText(com.hyphenate.helpdesk.R.string.recording_description);
					mRecordBtn.setBackgroundResource(com.hyphenate.helpdesk.R.drawable.hd_record_menu_mic_recording);
					//mDialogManager.recording();
					break;
				case STATE_WANT_TO_CANCEL:
					setBackgroundResource(com.hyphenate.helpdesk.R.drawable.hd_btn_recorder_recording);
					mRecordText.setText(com.hyphenate.helpdesk.R.string.release_to_cancel);
					mRecordBtn.setBackgroundResource(com.hyphenate.helpdesk.R.drawable.hd_record_menu_mic_cancel);
					break;
				default:
					break;
			}
