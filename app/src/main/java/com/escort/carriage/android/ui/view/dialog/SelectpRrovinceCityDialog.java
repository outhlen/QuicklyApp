 ...
 * 级联选择地址
 */
public class SelectpRrovinceCityDialog extends BaseDialogFragment {
    ...
    private View mFlag;
    public static SelectpRrovinceCityDialog getInstance() {
        return new SelectpRrovinceCityDialog();
    }
    public SelectpRrovinceCityDialog setContext(Context context){
        mContext = context;
        return this;
    }
    public SelectpRrovinceCityDialog setFlag(View object){
        mFlag = object;
        return this;
    }
    ...
    public void convertView(BaseDialogViewHolder holder, BaseDialogFragment dialog) {
        ...
        holder.getView(R.id.tvOk).setOnClickListener((v)->{
            if (mCallback != null && mCurrentCityBean != null){
                if (mFlag == null){
    ...
    //省
    private SelectpRrovinceCityDialog setProvinceList(List<ShengListBean.DataBean> provinceList) {
    ...
    //市
    private SelectpRrovinceCityDialog setCityList(List<ShiListBean.DataBean> cityList) {
        mCityList = cityList;
//        if (mCityList == null){
...
//        }
    ...
    //县
    private SelectpRrovinceCityDialog setAreaList(List<QuListBean.DataBean> areaList) {
        mAreaList = areaList;
...
//                UploadAnimDialogUtils.singletonDialogUtils().deleteCustomProgressDialog();
    ...
    public SelectpRrovinceCityDialog setProvinceCallback(ProvinceCallback callback){
    ...
    public SelectpRrovinceCityDialog setCityCallback(CityCallback callback){
    ...
    public SelectpRrovinceCityDialog setCallback(Callback callback){
        mCallback = callback;
        return this;
    }
