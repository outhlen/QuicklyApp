...
public class ChatRowTextCommentInvite extends ChatRow {
    ...
    protected void onInflatView() {
        inflater.inflate(message.direct() == Message.Direct.RECEIVE ?
                com.hyphenate.helpdesk.R.layout.hd_row_received_comment_invite : com.hyphenate.helpdesk.R.layout.hd_row_sent_message, this);
    }
    ...
    public void onSetUpView() {
        ...
        resolvedView = findViewById(com.hyphenate.helpdesk.R.id.tv_resolved);
        unsolvedView = findViewById(com.hyphenate.helpdesk.R.id.tv_unsolved);
