...
public class MNGestureView extends RelativeLayout {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mTracking) {
                    ...
                    if (currentTranslateY > mHeight / 3) {
                        onSwipeListener.downSwipe(getScaleX(), getScaleY(), getTranslationX(), getTranslationY());
                        break;
                    }
                }
                setViewDefault();
    ...
    public interface OnSwipeListener {
        //向下滑动
        void downSwipe(float scaleX, float scaleY, float translationX, float translationY);
