...
public class ChatRowVideo extends ChatRowFile {
    ...
    protected void onInflatView() {
        inflater.inflate(message.direct() == Message.Direct.RECEIVE ?
                com.hyphenate.helpdesk.R.layout.hd_row_received_video : com.hyphenate.helpdesk.R.layout.hd_row_sent_video, this);
    }

    @Override
    protected void onFindViewById() {
        imageView = ((ImageView) findViewById(com.hyphenate.helpdesk.R.id.chatting_content_iv));
        sizeView = (TextView) findViewById(com.hyphenate.helpdesk.R.id.chatting_size_iv);
        timeLengthView = (TextView) findViewById(com.hyphenate.helpdesk.R.id.chatting_length_iv);
        playView = (ImageView) findViewById(com.hyphenate.helpdesk.R.id.chatting_status_btn);
...
//        playView.setImageResource(R.drawable.video_play_btn_small_nor);
        ...
        if (message.direct() == Message.Direct.RECEIVE) {
            if (videoBody.thumbnailDownloadStatus() == EMFileMessageBody.EMDownloadStatus.DOWNLOADING ||
                ...
                imageView.setImageResource(com.hyphenate.helpdesk.R.drawable.hd_default_image);
