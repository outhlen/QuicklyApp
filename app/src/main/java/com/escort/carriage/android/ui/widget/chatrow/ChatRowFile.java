...
public class ChatRowFile extends ChatRow {
    ...
    protected void onInflatView() {
        inflater.inflate(message.direct() == Message.Direct.RECEIVE ?
                com.hyphenate.helpdesk.R.layout.hd_row_received_file : com.hyphenate.helpdesk.R.layout.hd_row_sent_file, this);
    }

    @Override
    protected void onFindViewById() {
        fileNameView = (TextView) findViewById(com.hyphenate.helpdesk.R.id.tv_file_name);
        fileSizeView = (TextView) findViewById(com.hyphenate.helpdesk.R.id.tv_file_size);
        fileStateView = (TextView) findViewById(com.hyphenate.helpdesk.R.id.tv_file_state);
    ...
    protected void onSetUpView() {
        ...
        if (message.direct() == Message.Direct.RECEIVE) { // 接收的消息
            ...
            if (file.exists()) {
                fileStateView.setText(com.hyphenate.helpdesk.R.string.Have_downloaded);
            } else {
                fileStateView.setText(com.hyphenate.helpdesk.R.string.Did_not_download);
            }
            return;
        }
