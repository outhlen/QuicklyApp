...
public abstract class BaseDialogFragment extends DialogFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setStyle(DialogFragment.STYLE_NO_TITLE, R.style.FrameworkBaseDialog);
    ...
    private void initParams() {
        ...
        if (window != null) {
            ...
            if (showBottom) {
                ...
                if (animStyle == 0) {
                    animStyle = R.style.FrameworkDefaultAnimation;
                }
            }

            //设置dialog宽度
            if (width == 0) {
                lp.width = getScreenWidth(context) - 2 * ResourcesTransformUtil.dp2px(context, margin);
            } else if (width == -1) {
                lp.width = WindowManager.LayoutParams.WRAP_CONTENT;
            } else {
                lp.width = ResourcesTransformUtil.dp2px(context, width);
            }
            ...
            if (height == 0) {
                ...
                lp.height = ResourcesTransformUtil.dp2px(context, height);
            }
