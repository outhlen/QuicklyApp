...
public class BubbleImageView extends AppCompatImageView {
    ...
    private void initView(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, com.hyphenate.helpdesk.R.styleable.BubbleImageView);
            mAngle = (int) a.getDimension(com.hyphenate.helpdesk.R.styleable.BubbleImageView_bubble_angle, mAngle);
            mArrowHeight = (int) a.getDimension(com.hyphenate.helpdesk.R.styleable.BubbleImageView_bubble_arrowHeight, mArrowHeight);
            mArrowOffset = (int) a.getDimension(com.hyphenate.helpdesk.R.styleable.BubbleImageView_bubble_arrowOffset, mArrowOffset);
            mArrowTop = (int) a.getDimension(com.hyphenate.helpdesk.R.styleable.BubbleImageView_bubble_arrowTop, mArrowTop);
            mArrowWidth = (int) a.getDimension(com.hyphenate.helpdesk.R.styleable.BubbleImageView_bubble_arrowWidth, mAngle);
            mArrowLocation = a.getInt(com.hyphenate.helpdesk.R.styleable.BubbleImageView_bubble_arrowLocation, mArrowLocation);
            a.recycle();
        }
    }
