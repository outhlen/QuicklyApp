...
public class Preferences {
	...
	static private String KEY_ROBOT_TEXT = "robot";

	private SharedPreferences pref = null;
	private SharedPreferences.Editor editor = null;
	
	static public Preferences getInstance(Context context){
		if(instance==null)
	...
	public void setRobotText(String text){
		editor.putString(KEY_ROBOT_TEXT, text);
		editor.commit();
	}
	public String getRobotText(){
		return pref.getString(KEY_ROBOT_TEXT, Constant.DEFAULT_CUSTOMER_ACCOUNT);
	}
