...
import com.escort.carriage.android.ui.view.flow.OnTagSelectListener;
        ...
        public void onClick(View v) {
            if (currentDegree != null && currentDegree.getAppraiseTag() != null && !currentDegree.getAppraiseTag().isEmpty()){
                if (selectedTags == null || selectedTags.isEmpty()){
                    ToastHelper.show(getBaseContext(), "请选择星级服务标签");
                    return;
                }
            }
                ...
                public void onSuccess() {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            ToastHelper.show(getBaseContext(), "评价成功");
                            setResult(RESULT_OK);
                            finish();
                        }
                    });
                ...
                public void onError(int code, String error) {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            ToastHelper.show(getBaseContext(), "评价失败");
                        }
                    });
                }
