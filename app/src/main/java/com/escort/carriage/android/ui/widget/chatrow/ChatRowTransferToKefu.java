...
public class ChatRowTransferToKefu extends ChatRow {
    ...
    protected void onInflatView() {
        inflater.inflate(message.direct() == Message.Direct.RECEIVE ? com.hyphenate.helpdesk.R.layout.hd_row_received_transfertokefu
                : com.hyphenate.helpdesk.R.layout.hd_row_sent_transfertokefu, this);
    }

    @Override
    protected void onFindViewById() {
        btnTransfer = (Button) findViewById(com.hyphenate.helpdesk.R.id.btn_transfer);
        tvContent = (TextView) findViewById(com.hyphenate.helpdesk.R.id.tv_chatcontent);
