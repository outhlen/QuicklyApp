...
public class ChatRowImage extends ChatRowFile {
    ...
    protected void onInflatView() {
        inflater.inflate(message.direct() == Message.Direct.RECEIVE ? com.hyphenate.helpdesk.R.layout.hd_row_received_picture : com.hyphenate.helpdesk.R.layout.hd_row_sent_picture, this);
    }
