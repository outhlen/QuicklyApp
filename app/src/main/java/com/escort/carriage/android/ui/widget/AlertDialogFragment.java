...
public class AlertDialogFragment extends DialogFragment {
    ...
    * **/
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View dialogView = inflater.inflate(com.hyphenate.helpdesk.R.layout.hd_fragment_alert_dialog_layout, null);
		((TextView) dialogView.findViewById(com.hyphenate.helpdesk.R.id.alert_tittle)).setText(title);
		((TextView) dialogView.findViewById(com.hyphenate.helpdesk.R.id.alert_content)).setText(content);
		//LeftButton default gone

		if (showLeftBtn) {
			Button leftBtn = (Button) dialogView.findViewById(com.hyphenate.helpdesk.R.id.alert_left_btn);
		...
		Button rightbtn = (Button) dialogView.findViewById(com.hyphenate.helpdesk.R.id.alert_right_btn);
		//RightButton
